...
export default function EditorClient({ video }: EditorClientProps) {
  ...
  return (
    <div className="relative min-h-screen p-6 md:p-12 max-w-7xl mx-auto z-10">
      ...
      {/* Header */}
      <header className="flex justify-between items-center mb-8 border-b border-zinc-200 pb-6">
        <div className="flex items-center gap-4">
          <Link href="/dashboard" className="p-2.5 bg-white border border-zinc-200 hover:border-zinc-300 text-zinc-500 hover:text-zinc-900 rounded-xl transition-all">
          ...
          <div>
            <div className="flex items-center gap-2">
              <input 
                ...
                className="bg-transparent text-2xl font-bold text-zinc-900 border-b border-transparent hover:border-zinc-300 focus:border-red-500 focus:outline-none px-1"
              />
            </div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 bg-white hover:bg-zinc-100 disabled:opacity-50 text-zinc-900 rounded-xl font-medium border border-zinc-200 hover:border-red-700 transition-all duration-200"
          ...
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="flex items-center gap-2 px-5 py-2.5 btn-glossy-red text-white rounded-xl font-medium transition-all duration-200"
          >
